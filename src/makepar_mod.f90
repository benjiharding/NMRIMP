...
contains
   ...
   subroutine makepar(parfile)
      ...
      write (99, "(A)") '0  1  -1.5                        - consider factor precedence? (0=no, 1=yes), factor index, wt'
      write (99, "(A)") '0  0.9  1                         - seed values? (0=no, 1=yes), threshold to seed, factor index'
      write (99, "(A)") '20                                - exclusion radius for seeded values (approx. 5-10*comp length)'
